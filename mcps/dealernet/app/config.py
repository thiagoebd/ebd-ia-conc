...
class OracleConfig:
    ...
    def from_env(cls) -> "OracleConfig":
        ...
        required = ["DN_USER", "DN_PASSWORD", "DN_DSN"]
        ...
        return cls(
            user=os.environ["DN_USER"],
            password=os.environ["DN_PASSWORD"],
            dsn=os.environ["DN_DSN"],
            pool_min=int(os.environ.get("DN_POOL_MIN", "2")),
            pool_max=int(os.environ.get("DN_POOL_MAX", "10")),
            query_timeout_ms=int(os.environ.get("DN_QUERY_TIMEOUT_MS", "30000")),
            default_row_limit=int(os.environ.get("DN_DEFAULT_ROW_LIMIT", "10000")),
        )
